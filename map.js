  ...
  fetch('japan.svg')
    ...
    .then(svgText => {
      ...
      const groupBoxSettings = {
        ...
        Path_6: { top:['Tottori','Shimane','Okayama','Hiroshima'], bottom:['Tokushima','Kagawa','Kochi','Ehime'] },
      ...
      const top2Dummy = createTop2Dummy();  // ← 新規 Top-2 Dummy
      ...
      function createTop2Dummy(){
        ...
        wrapper.style.position='absolute';
        wrapper.style.top='40px'; // topDummy より下に配置
        wrapper.style.left='50%';
        wrapper.style.transform='translateX(-50%)';
        wrapper.style.display='none';
        wrapper.style.gap='6px';
