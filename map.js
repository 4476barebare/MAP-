  ...
  fetch('japan.svg')
    ...
    .then(svgText => {
      ...
      const groupBoxSettings = {
        ...
        Path_6: { 
          top1:['Tottori','Shimane','Okayama','Hiroshima'], // Top-1 Dummy
          top2:['Yamaguchi','Tokushima','Kagawa','Kochi'],  // Top-2 Dummy
          bottom:['Ehime'] // Bottom Dummy
        },
      ...
      const prefNames = {
        ...
        Gifu:'岐阜県', Aichi:'愛知県',
        Mie:'三重県', Nara:'奈良県', Wakayama:'和歌山県', Osaka:'大阪府',
        Shiga:'滋賀県', Kyoto:'京都府', Hyogo:'兵庫県',
