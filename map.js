  ...
  fetch('japan.svg')
    ...
    .then(svgText => {
      ...
      const groupBoxSettings = {
        ...
        Path_6: { top:[0,1,2,3], bottom:[0,1,2,3] },
      ...
      const groupToPrefectures = {
        ...
        Path_5:['Mie','Nara','Wakayama','Osaka','Shiga','Kyoto','Hyogo','Fukui'],
      ...
      function hideAllBoxes(){
        [topDummy,bottomDummy,leftTopDummy,rightBottomDummy,leftBottomDummy,rightTopDummy].forEach(wrapper=>{
      ...
      function showBoxes(gid){
        ...
        Object.keys(setting).forEach(pos=>{
          ...
          setting[pos].forEach(i=>{
            if(wrapper.children[0].children[i]){
              wrapper.children[0].children[i].style.display='flex';
            }
          });
        });
      }
